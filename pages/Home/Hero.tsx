  ...
  return (
    <div className="">
      ...
      >
        {/* first slide */}
        <SwiperSlide>
          <div className="bg-hero-image-1 bg-cover bg-center h-[37rem] overflow-hidden">
            <div className="container mx-auto px-4 py-8 h-screen flex justify-center items-center">
              <div className="flex flex-col items-center mt-10 md:mt-0">
                <div className="md:w-4/6">
                  <h1
                    className="text-3xl md:text-5xl text-white font-bold mb-4 text-start md:text-center"
                    style={{ lineHeight: "138.5%" }}
                  >
                    Empower Your Business with Innovative ICT Solutions
                  </h1>
                </div>
                <p className="text-white text-md  md:text-lg mb-8 lg:w-[681px] leading-[30px] text-start font-light">
        ...
        {/* 2nd slide */}
        <SwiperSlide>
          <div className="bg-hero-image-2 bg-cover bg-center h-[37rem] overflow-hidden">
            <div className="container mx-auto px-4 py-8 h-screen flex justify-center items-center">
              <div className="flex flex-col items-center mt-10 md:mt-0">
                <div className="md:w-4/6">
                  <h1
                ...
                <p className="text-white text-start text-md  md:text-lg mb-8 lg:w-[681px] leading-[30px] font-light">
                  At Tabaarak ICT Solutions, we are dedicated to transforming
                  businesses with our advanced ICT solutions. Our focus is on
                  delivering state-of-the-art technologies that ignite growth,
                  optimize efficiency.
      ...
      <div className="domain-search-section -mt-[2rem] relative z-10">
        ...
        <div className="flex gap-4 flex-wrap px-4 justify-center mt-5 bg-background">
